...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 header-custom">
        ...
        <div class="button-group">
            ...
            <a href="{{ route('admin.membresias.create') }}" class="btn btn-custom-green">
            ...
            <tbody>
                ...
                <tr class="{{ $index % 2 === 0 ? 'row-even' : 'row-odd' }}">
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.membresias.edit', $membresia->id) }}" class="btn btn-icon btn-edit">
                        ...
                        <form action="{{ route('admin.membresias.destroy', $membresia->id) }}" method="POST" class="d-inline-block">
                            @csrf
                            @method('DELETE')
