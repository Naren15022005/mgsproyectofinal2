...
<div class="container ">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 header-custom">
        ...
        <div class="button-group">
            ...
            <a href="{{ route('recepcionista.productos.create') }}" class="btn btn-custom-green">
        ...
        <table class="table table-striped table-bordered table-custom">
            ...
            <tbody>
                ...
                <tr class="{{ $index % 2 === 0 ? 'row-even' : 'row-odd' }}">
                    ...
                    <td>
                        @if($producto->imagen)
                            <img src="{{ asset('images/' . $producto->imagen) }}" alt="{{ $producto->nombre }}" width="35" height="35">
                        @else
                            N/A
                        @endif
                    </td>
                    <td class="text-center">
                        <a href="{{ route('recepcionista.productos.edit', $producto->id) }}" class="btn btn-icon btn-edit">
                        ...
                        <form action="{{ route('recepcionista.productos.destroy', $producto->id) }}" method="POST" class="d-inline-block">
                            @csrf
                            @method('DELETE')
